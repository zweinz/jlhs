...
export const CARD_CATALOG: Record<CardId, CardDefinition> = Object.fromEntries(([
  ...
  curse('luxury-car', 'Curse of the Luxury Car', 'Xeno chooses a randomized mid-range MSRP threshold. Seekers must photograph a car whose typical original US MSRP meets or exceeds it.', { blocksQuestions: true, completionInstruction: 'Photograph a qualifying car and report the curse cleared. Exact model year and trim may be estimated on the honor system.' }),
...
export const UNPLAYABLE_AI_CURSES = new Set<CardId>(['cairn', 'ransom-note']);
