...
Hider mode accepts a Google Maps pin or browser geolocation and calculates answers for radar, thermometer, all in-play SF measuring subjects (including Sea Level, Body of Water, and Coastline), all mapped matching subjects, and tentacles. It does not silently write those calculated answers into the seeker state. Photo questions retain their exact framing/content notes but do not produce a geographic polygon.
